...
const setLogs = (logsList) => localStorage.setItem("ld_logs", JSON.stringify(logsList))

const initialState = {
  logs: localStorage.getItem("ld_logs") !== null ? JSON.parse(localStorage.getItem("ld_logs")) : [],
}
